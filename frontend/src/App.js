    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-16 h-16 bg-[#2563EB] hover:bg-[#1d4ed8] text-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-105 animate-pulse-glow z-50"
        >
